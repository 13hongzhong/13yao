    ...
    return (
        <div>
            <a href="https://toyhou.se/25710871.f2u-pagedoll-with-audio" target="_blank" rel="noopener noreferrer">
                <i className="fa-solid fa-code fixed bottom-4 right-4 z-[101]"></i>
            </a>
            <div className="hidden md:block fixed bottom-5 right-4 z-[9999] max-w-[15%] cursor-pointer" onClick={handleClick}>
                <div className="relative">
                    <i className="fas fa-comment fa-flip-horizontal fa-fade fa-5x animate-pulse text-gray-500"></i>
                    <div className="absolute top-0 left-0 w-full h-full z-[101]">
